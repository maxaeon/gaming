...
document.getElementById('show-suggested').addEventListener('click', () => {
  ...
  const btn = document.getElementById('show-suggested');
  if (div.hidden) {
    div.innerHTML = suggestedClustersHTML;
    div.hidden = false;
    div.classList.remove('hidden');
    btn.textContent = 'Hide Suggested Clusters';
  } else {
    div.innerHTML = '';
    div.hidden = true;
    div.classList.add('hidden');
    btn.textContent = 'Show Suggested Clusters';
  }
});
