window.criticalThinkingMidtermQuestions = {
  "Chapter 1 - Introduction": [
    ...
    { question: "What does 'self-interested thinking' refer to?", answer: "Thinking focused primarily on one's own interests rather than objective reasoning.", points: 400 },
  ...
  "Chapter 2 - Recognizing Arguments": [
    ...
    { question: "What is a conclusion indicator word? Give an example.", answer: "Words signaling a conclusion, e.g., 'therefore', 'thus', 'hence'.", points: 400 },
  ...
  "Chapter 3 - Basic Logical Concepts": [
    ...
    { question: "Define an invalid argument.", answer: "An argument where the conclusion does not necessarily follow from the premises.", points: 400 },
  ...
  "Chapter 4 - Language": [
    ...
    { question: "What is emotionally charged language?", answer: "Language intended to provoke emotions rather than clear reasoning.", points: 400 },
  ...
  "Chapter 5 - Logical Fallacies I": [
    ...
    { question: "What is a red herring fallacy?", answer: "Introducing irrelevant issues to divert attention.", points: 400 },
  ...
  "Chapter 6 - Logical Fallacies II": [
    ...
    { question: "Describe the hasty generalization fallacy.", answer: "Drawing conclusions from insufficient evidence.", points: 400 },
  ...
  "Chapter 7 - Analyzing Arguments": [
    ...
    { question: "What is an argument diagram?", answer: "Visual representation of an argument's structure.", points: 400 },
    { question: "Explain what makes an argument cogent.", answer: "It is inductively strong with all true premises.", points: 500 }
  ]
};
