...
window.criticalThinkingFinalQuestions = {
  "Evaluating Arguments & Truth Claims": [
    ...
    },
    {
      ...
      answer: "Demonstrating that the premises are false or that the conclusion does not logically follow.",
      points: 200
    },
    {
      question: "Name two main strategies for refuting arguments.",
      answer: "Show that a premise is false or dubious, or show that the conclusion does not logically follow from the premises.",
      points: 300
    },
    {
      question: "If a premise relies on an expert's claim, when should you question it?",
      answer: "If the expert lacks proper credentials, appears biased, or credible experts disagree.",
      points: 400
    },
    {
      question: "What does it mean for a conclusion to not follow from the premises?",
      answer: "The argument's logic is flawed so the premises, even if true, fail to support the conclusion.",
      points: 500
    }
  ],
